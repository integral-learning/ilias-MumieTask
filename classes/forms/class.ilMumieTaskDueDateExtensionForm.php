...
class ilMumieTaskDueDateExtensionForm extends ilPropertyFormGUI
{
    ...
    public function setFields()
    {
        ...
        if(ilMumieDeadlineExtensionService::wasDueDateOverriden($_GET["user_id"], $this->mumie_task)){
            $date_time = new ilDateTime(ilMumieDeadlineExtensionService::getOverridenDueDate($_GET["user_id"], $this->mumie_task), IL_CAL_UNIX);
        } else {
